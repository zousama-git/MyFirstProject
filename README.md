...
3. The Main Method for every Java program to run:
...
5. Customized the Look to make it easier to read, changeed the font size and change the text colors in the console
...
3. Explored "Reference" Types (Strings)
	Strings
